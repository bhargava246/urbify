// extra-pages.jsx — Broker Portfolio · Tenant Transactions · Settings · Help · 404
...
function ClientTxPage({nav}) {
  ...
  const transactions = [
    { id:"TXN-89231", listing:LISTINGS[0], date:"24 Nov 2025", amount:6250, status:"completed", method:"UPI" },
    { id:"TXN-89102", listing:LISTINGS[2], date:"18 Nov 2025", amount:5200, status:"completed", method:"Card" },
    { id:"TXN-88770", listing:LISTINGS[3], date:"12 Nov 2025", amount:9800, status:"completed", method:"UPI" },
    { id:"TXN-88401", listing:LISTINGS[5], date:"5 Nov 2025",  amount:5200, status:"refunded", method:"Card", reason:"Invalid address" },
    { id:"TXN-88210", listing:LISTINGS[1], date:"1 Nov 2025",  amount:7800, status:"completed", method:"NetBank" },
    { id:"TXN-87809", listing:LISTINGS[4], date:"22 Oct 2025", amount:11400, status:"completed", method:"UPI" },
    { id:"TXN-87412", listing:LISTINGS[6], date:"15 Oct 2025", amount:6250, status:"completed", method:"UPI" },
    { id:"TXN-86988", listing:LISTINGS[7], date:"8 Oct 2025",  amount:4800, status:"disputed", method:"Wallet", reason:"Disputed by tenant" },
  ];
  ...
  return (
    <PortalShell user={CLIENT_USER} navItems={CLIENT_NAV()} current="clientTx" onNav={(id)=>nav(id)}>
      ...
      <div style={{textAlign:'center', marginTop:32, fontSize:12, color:'var(--text-faint)'}}>
        Invoices are also emailed to <strong style={{color:'var(--text-muted)'}}>aanya@example.com</strong> · Need a custom GST certificate? <a style={{color:'var(--brand-500)', textDecoration:'underline'}}>Contact billing</a>
      </div>
    </PortalShell>
  );
}
...
function SettingsPage({nav}) {
  ...
  return (
    <PortalShell user={CLIENT_USER} navItems={CLIENT_NAV()} current="settings" onNav={(id)=>nav(id)}>
            ...
            <div className="card" style={{padding:32}}>
              ...
              <div style={{marginTop:16}}>
                <Field label="Bio (optional)">
                  <textarea className="input" rows="3" style={{height:'auto', padding:'12px 14px', resize:'vertical', lineHeight:1.5}} defaultValue="Product designer at Razorpay. Quiet neighbourhood preferred."/>
                </Field>
              </div>
...
function HelpPage({nav}) {
  ...
  const popular = [
    "How is the 7.5-day fee calculated?",
...
Object.assign(window, { BrokerPortfolioPage, ClientTxPage, SettingsPage, HelpPage, NotFoundPage });
