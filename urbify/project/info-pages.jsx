          ...
          <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center'}}>
            <div>
              ...
              <p style={{fontSize:17, opacity:.7, marginTop:20, lineHeight:1.55, maxWidth:520}}>
                Engineers, designers and ops people from Razorpay, CRED, Swiggy and Flipkart. We've all hated finding apartments. So we built the one we wanted.
              </p>
  ...
  const groups = [
    {
      title:"Pricing & fees",
      faqs:[
        ["How is the 7.5-day fee calculated?", "Take the monthly rent, divide by 30 to get the daily rent, multiply by 7.5. Add 18% GST on top. So a ₹40,000/month flat costs you ₹11,800 to unlock — about 25% of a month's rent, in line with our '25% of a month' rule."],
    ...
    },
    {
      title:"For brokers",
      faqs:[
        ["How do brokers earn?", "You and the owner agree on the commission like always. Urbify doesn't touch your owner-side cut. The 7.5-day fee we collect comes from the tenant, on top — it's our revenue, not yours."],
