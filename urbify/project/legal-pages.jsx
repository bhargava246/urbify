// legal-pages.jsx — Terms of Service · Privacy Policy · Refund Policy
      ...
      sections: [
        ...
        },
        {
          ...
          p: [
            ...
            "Tenants/buyers pay a platform fee to unlock the owner's contact details and full property address. The fee is calculated as 7.5 days of monthly rent (rent ÷ 30 × 7.5) plus 18% GST. The full calculation is shown before payment.",
            "Payments are processed via Razorpay or our other licensed payment partners. We do not store full card details on our servers.",
      ...
      sections: [
        {
          ...
          p: [
            ...
            "Payment data: handled by our payment processor (Razorpay). We store transaction IDs and amounts; full card and bank details are never stored on Urbify servers.",
        ...
        },
        {
          ...
          p: [
            "Payment processors (Razorpay, etc.) — only the minimum data required to process the transaction.",
